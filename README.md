...
2. **Install the Apigeecli:** Follow the instructions at [Install the gcloud CLI](https://github.com/apigee/apigeecli) to set up the Google Cloud command-line tools.
